...
public class MovieAPIBuilder {
    ...
    public MovieAPIBuilder(String baseURL){
        movieAPIRequest = new StringBuilder(baseURL);
    }

    public MovieAPIBuilder setQuery(String query) {
    ...
    public MovieAPIBuilder setGenre(Genre genre){
        if(genre != null){
            if(movieAPIRequest.indexOf(QUERY_SIGN_STRING) == -1) {
                movieAPIRequest.append(QUERY_SIGN_STRING);
            }
    ...
    public MovieAPIBuilder setReleaseYear(String releaseYear) {
        if(releaseYear != null) {
            if(movieAPIRequest.indexOf(QUERY_SIGN_STRING) == -1){
                movieAPIRequest.append(QUERY_SIGN_STRING);
            }
    ...
    public MovieAPIBuilder setRatingForm(String ratingForm) {
        if(ratingForm != null){
            if(movieAPIRequest.indexOf(QUERY_SIGN_STRING) == -1){
                movieAPIRequest.append(QUERY_SIGN_STRING);
            }
    ...
    public MovieAPIBuilder setID(UUID id) {
        if(id != null) {
    ...
    public String build() {
        ...
        if(finalMovieAPIRequest.charAt(lastIndexOfRequest) == QUERY_SIGN_CHAR || finalMovieAPIRequest.charAt(lastIndexOfRequest) == DELIMITER){
